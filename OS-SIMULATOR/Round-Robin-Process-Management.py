"""
    ...
    Program Description:
        - This is a program which mimics and represents the Round Robin Process Management.

    Program Algorithm:
        1. Initialize the program and create the tkinter GUI
        2. Ask for user input in input1_window of rRobin_frontEnd.
...
# Resources
#   -> Background
bg8 = PhotoImage(file = currentDirectory + "\\resources\\background\\bg8.png" )
...
class rRobin_frontEnd:
    ...
    def input1_window( self ):
        ...
        self.bg8LBL = Label ( root , image = bg8, bg = "black" )
        self.bg8LBL.place(x = 0, y = 0)
        self.basicWidgetList.append( self.bg8LBL )
...
program = rRobin_backEnd()
program.generate_ganttChart()

program1 = rRobin_frontEnd()
