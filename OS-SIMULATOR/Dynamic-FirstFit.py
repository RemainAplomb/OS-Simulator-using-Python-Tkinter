"""
    ...
    Program Description:
        - This is a program which mimics and represents the Dynamic First Fit Partitioned Allocation.

    Program Algorithm:
        1. Initialize the program and create the tkinter GUI
        2. Ask for user input in input1_window of dynamic_firstFit_frontEnd.
...
# Resources
#   -> Background
bg3 = PhotoImage(file = currentDirectory + "\\resources\\background\\bg3.png" )
...
class dynamic_firstFit_frontEnd:
    ...
    def input1_window( self ):
        ...
        self.bg3LBL = Label ( root , image = bg3, bg = "black" )
        self.bg3LBL.place(x = 0, y = 0)
        self.basicWidgetList.append( self.bg3LBL )
