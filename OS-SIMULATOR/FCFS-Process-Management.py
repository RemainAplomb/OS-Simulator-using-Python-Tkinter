"""
    ...
    Program Description:
        - This is a program which mimics and represents the First Come First Serve Process Management.

    Program Algorithm:
        1. Initialize the program and create the tkinter GUI
        2. Ask for user input in input1_window of fcfs_frontEnd.
...
root = Tk()
root.title ( "First Come First Serve Process Management" )
#

# Resources
#   -> Background
bg5 = PhotoImage(file = currentDirectory + "\\resources\\background\\bg5.png" )
...
class fcfs_frontEnd:
    ...
    def input1_window( self ):
        ...
        self.bg5LBL = Label ( root , image = bg5, bg = "black" )
        self.bg5LBL.place(x = 0, y = 0)
        self.basicWidgetList.append( self.bg5LBL )
